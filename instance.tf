...
# Install docker in the ubuntu
  provisioner "remote-exec" {
    inline = [
      ...
      "sed -i 's/<access_key>/${aws_iam_access_key.prometheus_access_key.id}/g' /prometheus-data/prometheus.yml;",
      "sed -i 's/<secret_key>/${aws_iam_access_key.prometheus_access_key.secret}/g' /prometheus-data/prometheus.yml",
